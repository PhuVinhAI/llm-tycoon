...
===============================================================================
FILE: 00_home_lab.md
MODULE: Scenarios / Home Lab

Mục đích:
Game State khởi đầu của chương Home Lab.

Tác dụng:
Đặt người chơi vào tháng 1/2013 — trước word2vec hai tháng, trước
Transformer bốn năm rưỡi, trước LLM đầu tiên cả một thời đại — với đúng
$10,000 tiết kiệm và một chiếc PC cũ trong phòng lab tại gia.

Trách nhiệm:
- Liệt kê giá trị khởi đầu của mọi trường trong Game State.
- Đặt chủ đề mở màn (engine được phép thêm màu theo Creative License,
  không đổi dữ kiện).
===============================================================================
-->
...
<!--
Tiếng Việt (tóm tắt):
Trạng thái đầu: 01/2013, $10,000, RP 0, Fame 0, R-Lv 1 / E-Lv 1, sở hữu BTP
...
Mở màn: tháng 1/2013, bạn nghỉ việc, biến căn phòng trống trong căn hộ
thuê chật hẹp thành "home lab": một chiếc bàn, máy tính cũ, bảng ghim đầy
paper in ra, và tấm bảng trắng ghi một câu: "Rồi sẽ có ngày máy tính thật
sự hiểu được ngôn ngữ." Bạn có $10,000 tiết kiệm và linh cảm rằng cơn sóng
deep learning từ nhận dạng ảnh sắp tràn sang ngôn ngữ. Chưa ai biết bạn là
ai — nhưng đó chỉ là chuyện tạm thời.
-->
