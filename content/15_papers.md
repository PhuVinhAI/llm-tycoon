...
===============================================================================
FILE: 15_papers.md
MODULE: Content / Papers

Mục đích:
Ma trận sự kiện phát sinh giữa quá trình viết báo khoa học (Paper).

Tác dụng:
Tạo ra các tình huống đánh đổi mang đậm chất hàn lâm (Reviewer 2, Open-source,
Co-author, Overclaim) để việc viết báo không chỉ là chờ đợi.
===============================================================================
-->
