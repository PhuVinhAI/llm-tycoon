...
This directory defines initial Game States — the starting point of a playthrough.
...
* The starting date and starting values of all resources, skills, technologies, hardware, team, and datasets.
* The opening narration theme.

Scenarios do not introduce mechanics, data, or entities.
