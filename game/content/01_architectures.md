...
<!--
Tiếng Việt (tóm tắt):
Bảng thông số kiến trúc: Base Q (điểm nền), yêu cầu TFLOPS-month, số tháng tối
...
cũ; còn lại là neural — cần GPUT và ít nhất 100 TFLOPS. Dự án LLM nâng yêu cầu
compute của PTRF lên 60,000 TFLOPS-month.
-->
