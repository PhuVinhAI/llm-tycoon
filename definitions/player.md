...
Player tồn tại bên ngoài thế giới của game và không được xem là một thực thể trong mô phỏng.

Player có thể được gắn với các thông tin như:

* Danh tính.
* Các Company mà Player điều khiển.
* Tiến trình hiện tại.
* Các Player Action có thể thực hiện.

Player có thể:

* điều khiển một hoặc nhiều Company;
* thực hiện Player Action;
* nhận Outcome từ Game Engine;
* tác động đến Game State thông qua các Player Action hợp lệ.
